    ...
    <div className='flex-1 p-4 flex flex-col gap-4 xl:flex-row'>
     ...
     <div className='w-full xl:w-2/3'>
      ...
      <div className='bg-lamaSky py-6 px-4 rounded-md flex-1 flex gap-4'>
         ...
         <div className='w-2/3 flex flex-col justify-between gap-4'>
          <h1 className='text-xl font-semibold'>Nicholas Kidudu</h1>
          ...
          <div className='flex items-center justify-between gap-2 flex-wrap text-xs font-medium'>
            ...
            <div className='w-full md:w-1/3 lg:w-full 2xl:w-1/3 flex items-center gap-2'>
              ...
              <span>ogikimoses@students.mak.ac.ug</span>
            </div>
            <div className='w-full md:w-1/3 lg:w-full 2xl:w-1/3 flex items-center gap-2'>
      ...
      <div className='flex-1 flex gap-4 justify-between flex-wrap'>
        {/* CARD */}
         <div className='bg-white p-4 rounded-md flex gap-4 w-full md:w-[48%] xl:w-[45%] 2xl:w-[48%]'> 
          <Image src="/course1.png" alt='' height={20} width={20} className='w-6 h-6'/>
          <div className=''>
         ...
         {/* CARD */}
         <div className='bg-white p-4 rounded-md flex gap-4 w-full md:w-[48%] xl:w-[45%] 2xl:w-[48%]'>
          <Image src="/Supervisor1.png" alt='' height={20} width={20} className='w-6 h-6'/>
          <div className=''>
     ...
     <div className='bg-white p-4 rounded-md '>
        ...
        <div className='mt-4 flex gap-4 flex-wrap text-xs text-gray-500'>
          <Link className='p-3 rounded-md bg-lamaSky' href="/">Student&apos;s Assignments</Link>
          <Link className='p-3 rounded-md bg-lamaYellow' href="/">Student&apos;s Announcements</Link>
          <Link className='p-3 rounded-md bg-lamaSkyLight' href="/">Student&apos;s Events</Link>
          <Link className='p-3 rounded-md bg-lamaSkyLight' href="/">Student&apos;s Supervisor</Link>
        </div>
     </div>
