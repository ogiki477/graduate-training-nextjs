...
const Navbar = () => {
  return (
    <div className='flex justify-between items-center p-4'> 
     {/* SEARCH BAR */}
     <div className='hidden md:flex items-center gap-2 bg-white text-xs rounded-full ring-[1.5px] ring-gray-300 px-2'>
     <Image src="/search.png" alt='' width={14} height={14}/>
     <input type="text" placeholder='search..' className='w-[200px ] p-2 bg-transparent'></input>
     ...
     {/* ICONS AND USER */}
        <div className='flex items-center gap-6 justify-end w-full'>
          ...
          <div className='flex flex-col'>
            <span className='text-x5 leading-3 font-medium'>Ogiki</span>
